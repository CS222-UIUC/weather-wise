...
export default class WeatherWarnings extends React.Component<MyProps> {
    render() {
        ...
        if (temperature <= 0) {
            temp_advice =
                "Be careful, it's really cold out! Make sure to wear lots of layers!"
            ...
            temp_advice =
                'Be careful of the high temperatures! Consider staying indoors and be sure to stay hydrated!'
        }
        return (
